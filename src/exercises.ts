...
function reflectSpatialToken(value: VisualToken, axis: 'vertical' | 'horizontal'): VisualToken {
  ...
  // Glyph rotations are relative to each shape's drawn base direction: arrows
  // start facing right, while triangles start facing up. Reflect the absolute
  // direction, then convert back to the shape-relative rotation.
